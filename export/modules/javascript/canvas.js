define(['dojo/_base/declare'], (declare) => {
    return declare('pyramido.canvas', null, {
        ...
        add(paintable) {
            ...
            paintable.move_to(this.element_id, 0, 0);
            this.paintables.push(paintable);
        },
        resize_element() {
            this.dojo.style(this.element_id, 'width', '' + this.PIXELS_PER_TILE + 'px');
            this.dojo.style(this.element_id, 'height', '' + this.PIXELS_PER_TILE + 'px');
        },
